...
class WhiteViewController: UIViewController
{
    ...
    lazy var titleButton: UIButton = {
        let view = UIButton()
        view.setTitle("点击", for: .normal)
        view.setTitleColor(UIColor.black, for: .normal)
        view.setImage(#imageLiteral(resourceName: "键盘切换-拍照"), for: .normal)
        return view
    }()
...
//        navBarBackgroundAlpha = 0
        initNavBarTitle("空间", backgroundType: .white, leftButton: nil, rightButton: .image(#imageLiteral(resourceName: "键盘切换-拍照"), #selector(buttonAction)), titleView: .view(titleButton))
    }
...
extension WhiteViewController: UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath)
    {
        ...
        let vc:UIViewController = NewViewController()
